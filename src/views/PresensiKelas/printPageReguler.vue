<template>
    <div class="printme" id="all-products" style="margin:25px">
        ...
        <h6 style="font-weight:bold; text-align: left; ">STRUK PRESENSI KELAS</h6>
        ...
        <table style="text-align: left; font-size: medium;">
                ...
                <tr>
                    <th><h6>Tariff</h6></th>
                    <th><h6> : Rp {{ presensiKelas.tariff}}</h6></th>
                </tr>
                <tr>
                    <th><h6>Sisa Deposit</h6></th>
                    <th><h6> : Rp {{ presensiKelas.sisa_deposit}}</h6></th>
                </tr>
        </table>
    </div>
...
export default {
    ...
    .then(response => {
        ...
        presensiKelas.sisa_deposit =  response.data.data.SISA_DEPOSIT
        })
    })
    function strukPrint() {
        window.print();
